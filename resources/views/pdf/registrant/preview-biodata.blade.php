                ...
                <div class="page-1">
                    ...
                    <div class="preview-menu">
                        ...
                        <div class="link-cover">
                            <a class="export-link" href="{{ route('biodata.export.manual', ['identifier' => $user, 'code' => $code]) }}">
                                Manual Download
                            </a>
                            <a class="export-link" href="{{ route('biodata.export.auto', ['identifier' => $user, 'code' => $code]) }}">
                                Auto Download
                            </a>
                        </div>
                    </div>
