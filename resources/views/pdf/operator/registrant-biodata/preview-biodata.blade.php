...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('css/biodata-report.css') }}" rel="stylesheet">
    </head>
    ...
    <body>
        ...
        <div class="main">
            <div class="container">
                <div class="page-1">
                    <div class="header">
                        <img src="{{ asset('storage/image/biodata/kop8.png') }}" alt="">
                    </div>
                    <div class="preview-menu">
                        ...
                        <div class="link-cover">
                            <a class="export-link" href="{{ route('registrant.pdf.manual', ['identifier' => $user, 'code' => $code]) }}">
                                Manual Download
                            </a>
                            <a class="export-link" href="{{ route('registrant.pdf.auto', ['identifier' => $user, 'code' => $code]) }}">
                                Auto Download
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="table-2">
                        <table>
                            <tr>
                                <th class="image">
                                    <img class="profile" src="{{ asset('storage/' . $user->picture) }}" alt="{{ $user->name }}" style="width: 150px">
                                </th>
                                <td class="sign-mark">
