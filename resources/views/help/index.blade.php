        ...
        <div class="space-y-6">
            <x-header title="Helper" description="1">
                <x-slot:header>
                    ...
                    Jika anda mendapat masalah atau bug di website ini, silahkan screenshot dan hubungi operator kami.
                    {{-- Lorem ipsum dolor, sit amet consectetur adipisicing elit. Obcaecati iure maxime animi necessitatibus saepe soluta neque. Neque assumenda, rerum accusantium perferendis libero aperiam eveniet quisquam vero, est alias officia blanditiis accusamus voluptatum corporis, quod impedit. --}}
                </x-slot:header>
            </x-header>
            <div class="flex flex-wrap justify-evenly gap-5">
                @foreach ($operators as $item)
                    <div class="w-full max-w-[16rem] p-5 dark:bg-transparent">
                        <div class="flex flex-col items-center">
                            <img class="mb-3 h-24 w-24 rounded-full shadow-lg" src="{{ asset('storage/' . $item->picture) }}" alt="Bonnie image" />
                            ...
                            <div class="mt-4 md:mt-6">
                                <a class="inline-flex items-center gap-1 rounded-xl border border-gray-200 bg-white px-4 py-2 text-center text-sm font-medium text-gray-900 shadow hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-700 dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950 dark:text-white dark:hover:border-gray-500 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
                                    href="https://wa.me/62{{ $item->whatsapp }}" target="_blank">
...
{{-- Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sequi, ad nihil laboriosam asperiores facilis dicta, unde labore recusandae voluptatum ipsa voluptate error quas optio consectetur, ab placeat molestias quis amet. --}}
