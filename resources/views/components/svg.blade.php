...
<svg class="{{ $class }}" xmlns="http://www.w3.org/2000/svg" fill="{{ $fill }}" viewBox="{{ $viewBox }}" stroke-width="{{ $strokeWidth }}" stroke="{{ $stroke }}">
    @switch($svg)
        @case('dashboard')
        ...
        @case('operator-list')
            <g clip-path="url(#clip0_322_456)">
                ...
                <path d="M8.5 20H3V18C3 16.9391 3.42143 15.9217 4.17157 15.1716C4.92172 14.4214 5.93913 14 7 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path
