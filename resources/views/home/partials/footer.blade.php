{{-- <footer class="bg-gradient-to-bl from-gray-950 via-gray-800 to-gray-950 pt-24 pb-12"> --}}
<footer
    class="bg-gradient-to-bl from-black via-teal-950 to-black dark:bg-gradient-to-t dark:from-black dark:via-teal-950 dark:to-black pt-24 pb-12">
    <div class="container">
        <div class="flex flex-wrap">
            ...
            <div class="w-full px-2 mb-12 md:w-1/3 2xl:pl-14">
                <h3 class="text-lg text-white font-semibold mb-4">Lessons</h3>
                <ul class="text-slate-300 dark:text-slate-400">
                    <li>
                        <a href="#" class="text-base inline-block hover:text-primary mb-2">Programming</a>
                    </li>
                    <li>
                        <a href="#" class="text-base inline-block hover:text-primary mb-2">Desain
                            Grafis</a>
                    </li>
                    <li>
                        <a href="#" class="text-base inline-block hover:text-primary mb-2">Multimedia</a>
                    </li>
                </ul>
            </div>
            <div class="w-full px-2 mb-12 md:w-1/3 2xl:pl-14">
                <h3 class="text-lg text-white font-semibold mb-4">Tautan</h3>
                <ul class="text-slate-300  dark:text-slate-400">
                    <li>
                        <a href="#home" class="text-base inline-block hover:text-primary mb-2">Home</a>
                    </li>
                    <li>
                        <a href="#lessons" class="text-base inline-block hover:text-primary mb-2">Lessons</a>
                    </li>
                    <li>
                        <a href="#devision" class="text-base inline-block hover:text-primary mb-2">Devision</a>
                    </li>
                    <li>
                        <a href="#events" class="text-base inline-block hover:text-primary mb-2">Events</a>
                    </li>
                    <li>
                        <a href="#galleries" class="text-base inline-block hover:text-primary mb-2">Gallery</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="w-full border-t border-slate-500">
            <!-- Icons -->
            <div class="flex items-center justify-center my-5 gap-x-5">
                <a href="https://www.instagram.com/studyclubinformatika/" target="_blank" rel="noopener noreferrer">
                    <div
                        class="bg-gradient-to-bl from-teal-950 via-black to-teal-950 w-12 h-12 border border-gray-700 rounded-lg shadow hover:scale-110 hover:shadow-xl transition duration-300 flex items-center justify-center dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950 dark:border-gray-700">
                ...
                <a href="https://www.facebook.com/studyclubinformatika.sci" target="_blank" rel="noopener noreferrer">
                    <div
                        class="bg-gradient-to-bl from-teal-950 via-black to-teal-950 w-12 h-12 border border-gray-700 rounded-lg shadow hover:scale-110 hover:shadow-xl transition duration-300 flex items-center justify-center dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950  dark:border-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                            class="main-grid-item-icon" fill="none">
            ...
            <!-- /Icons -->
            <p class="text-[12px] text-slate-300 text-center xl:text-sm">Copyright By <a
                    href="https://www.instagram.com/studyclubinformatika/" target="_blank"
                    class="font-semibold hover:text-primary transition duration-300">{{ '@Studyclubinformatika' }}</a>
                All Right Reserved.</p>
            <p class="text-[12px] text-slate-300 text-center xl:text-sm">Massive thanks to <a
                    href="https://laravel.com/docs/10.x/starter-kits#laravel-breeze" target="_blank"
                    class="font-semibold hover:text-orange-500 transition duration-300">Laravel
                    Breeze</a> & <a href="https://tailwindcss.com/" target="_blank"
                    class="font-semibold hover:text-sky-500 transition duration-300">TailwindCSS</a>.</p>
        </div>
    </div>
</footer>
