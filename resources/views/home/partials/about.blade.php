<section class="pt-20 lg:py-32" id="about">
    <div class="container">
        <div class="text-center">
            <h4 class="text-md mb-8 font-bold text-dark dark:text-white lg:text-lg">ABOUT US</h4>
        </div>
        <div class="flex flex-wrap">
            <div class="mb-10 w-full lg:w-1/2">
                <h3 class="text-lg font-semibold text-dark dark:text-gray-100">Halo, Kami</h3>
                <h2 class="mb-1 text-2xl font-bold text-primary lg:text-3xl">Study Club Informatika</h2>
                <p class="mb-2 max-w-lg text-justify text-sm font-medium text-secondary dark:text-gray-400 sm:max-w-full lg:max-w-md xl:max-w-xl">
                ...
                <p class="max-w-lg text-justify text-sm font-medium text-secondary dark:text-gray-400 sm:max-w-full lg:max-w-md xl:max-w-xl">
            ...
            <div class="mb-10 w-full sm:pt-[27px] lg:w-1/2 lg:pl-4">
                <h3 class="mb-[10px] text-xl font-bold text-dark dark:text-gray-100 lg:text-2xl">Mau tau lebih banyak..?
                </h3>
                <p class="max-w-xl text-justify text-sm font-medium text-secondary dark:text-gray-400">Kunjungi kami
                    dibawah ini
                    untuk
                ...
                <div class="mt-3 flex items-center gap-x-5">
                    <a href="https://www.instagram.com/studyclubinformatika/" target="_blank" rel="noopener noreferrer">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-lg border border-gray-300 bg-gradient-to-bl from-teal-100 via-white to-teal-100 shadow transition duration-300 hover:scale-110 hover:shadow-xl dark:border-gray-700 dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950">
                            <svg class="main-grid-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                                <path clip-rule="evenodd" d="M12 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324ZM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" fill="url(#instagram__a)"
                                    fill-rule="evenodd" />
                                ...
                                <defs>
                                    <linearGradient id="instagram__a" gradientUnits="userSpaceOnUse" x1="14.101" x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                                        <stop offset="1" stop-color="#FFBF00" />
                                    </linearGradient>
                                    <linearGradient id="instagram__b" gradientUnits="userSpaceOnUse" x1="14.101" x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                                        <stop offset="1" stop-color="#FFBF00" />
                                    </linearGradient>
                                    <linearGradient id="instagram__c" gradientUnits="userSpaceOnUse" x1="14.101" x2="7.087" y1="-1.272" y2="21.899">
                                        <stop stop-color="#515BD4" />
                                        <stop offset=".26" stop-color="#9510B8" />
                                        <stop offset=".66" stop-color="#E51804" />
                                        <stop offset="1" stop-color="#FFBF00" />
                    ...
                    <a href="https://www.youtube.com/@studyclubinformatika1734" target="_blank" rel="noopener noreferrer">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-lg border border-gray-300 bg-gradient-to-bl from-teal-100 via-white to-teal-100 shadow transition duration-300 hover:scale-110 hover:shadow-xl dark:border-gray-700 dark:bg-gradient-to-bl dark:from-teal-950 dark:via-black dark:to-teal-950">
                            <svg class="main-grid-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
                                <path clip-rule="evenodd"
